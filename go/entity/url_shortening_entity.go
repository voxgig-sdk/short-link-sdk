...
func NewUrlShorteningEntity(client *core.ShortLinkSDK, entopts map[string]any) *UrlShorteningEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UrlShorteningEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UrlShorteningEntity) Deleted() bool {
	return e.deleted
}
...
func (e *UrlShorteningEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UrlShorteningLoadMatch and returns an UrlShortening. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UrlShorteningEntity) LoadTyped(reqmatch UrlShorteningLoadMatch, ctrl map[string]any) (UrlShortening, error) {
...
func (e *UrlShorteningEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
