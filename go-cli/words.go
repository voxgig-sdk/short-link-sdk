...
func registerSDKWords(r *eng.Registry, client *sdk.ShortLinkSDK) {
...
func runOp(client *sdk.ShortLinkSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
