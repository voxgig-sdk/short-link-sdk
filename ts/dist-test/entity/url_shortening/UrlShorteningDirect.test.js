...
(0, node_test_1.describe)('UrlShorteningDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ShortLinkSDK({
    ...
    (0, node_test_1.test)('direct-load-url_shortening', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-url_shortening', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SHORT_LINK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ShortLinkSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SHORT_LINK_TEST_URL_SHORTENING_ENTID'];
    ...
    const client = new __1.ShortLinkSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UrlShorteningDirect.test.js.map