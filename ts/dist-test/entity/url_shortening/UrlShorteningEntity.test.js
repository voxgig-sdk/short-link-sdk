...
(0, node_test_1.describe)('UrlShorteningEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('SHORT_LINK_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.ShortLinkSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.ShortLinkSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.ShortLinkSDK(merge([
