...
function envOverride(m) {
    if ('TRUE' === process.env.SHORT_LINK_TEST_LIVE ||
        'TRUE' === process.env.SHORT_LINK_TEST_OVERRIDE) {
    ...
    m.SHORT_LINK_TEST_EXPLAIN = process.env.SHORT_LINK_TEST_EXPLAIN || m.SHORT_LINK_TEST_EXPLAIN;
    return m;
}
