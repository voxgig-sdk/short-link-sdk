...
class UrlShorteningEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SHORT_LINK_TEST_URL_SHORTENING_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def url_shortening_basic_setup(extra)
  ...
  entid_env_raw = ENV["SHORT_LINK_TEST_URL_SHORTENING_ENTID"]
