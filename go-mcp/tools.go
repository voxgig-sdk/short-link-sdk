...
type Args struct {
	Entity string         `json:"entity" jsonschema:"url_shortening"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ShortLinkSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "short-link_list",
		Description: "List records from ShortLink. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "short-link_load",
		Description: "Load a single record from ShortLink. " +
...
func runOp(client *sdk.ShortLinkSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ShortLinkSDK, name string) (sdk.ShortLinkEntity, error) {
	switch strings.ToLower(name) {
	case "url_shortening":
		return client.UrlShortening(nil), nil
