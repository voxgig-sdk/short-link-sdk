...
describe("UrlShorteningDirect", function()
  it("should direct-load-url_shortening", function()
    local setup = url_shortening_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-url_shortening", setup.live and "live" or "unit")
