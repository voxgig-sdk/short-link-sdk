...
describe("UrlShorteningEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHORT_LINK_TEST_URL_SHORTENING_ENTID JSON to run live")
      return
    end
...
function url_shortening_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHORT_LINK_TEST_URL_SHORTENING_ENTID")
  ...
  if env["SHORT_LINK_TEST_LIVE"] == "TRUE" then
