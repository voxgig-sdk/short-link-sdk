...
class ShortLinkGraphql
{
    ...
    // equivalent.
    public static function body(ShortLinkContext $ctx): mixed
    {
    ...
    public static function errors(ShortLinkContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
