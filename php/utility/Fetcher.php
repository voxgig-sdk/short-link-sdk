...
class ShortLinkFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ShortLinkSDK/1.0)';
    ...
    public static function call(ShortLinkContext $ctx, string $fullurl, array $fetchdef): array
    {
