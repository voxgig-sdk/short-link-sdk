...
class UrlShorteningEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SHORT_LINK_TEST_URL_SHORTENING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function url_shortening_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SHORT_LINK_TEST_URL_SHORTENING_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["SHORT_LINK_TEST_URL_SHORTENING_ENTID"]);
