...
// ShortLink SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ShortLinkSDK::test)
...
{
    private const SDK_CLASS = 'ShortLinkSDK';
    ...
    private const SDK_BASE = 'shortlink_sdk';
