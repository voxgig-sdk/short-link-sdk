...
class ShortLinkCacheFeature extends ShortLinkBaseFeature
{
    ...
    private function _through(ShortLinkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
