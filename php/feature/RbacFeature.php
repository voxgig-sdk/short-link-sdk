...
class ShortLinkRbacFeature extends ShortLinkBaseFeature
{
    ...
    private function _required(ShortLinkContext $ctx): ?string
    {
    ...
    private function _reject(ShortLinkContext $ctx, string $required): void
    {
    ...
    private function _track(ShortLinkContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
