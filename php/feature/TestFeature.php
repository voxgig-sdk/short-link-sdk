...
// ShortLink SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ShortLinkTestFeature extends ShortLinkBaseFeature
{
    ...
    public function init(ShortLinkContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ShortLinkContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ShortLinkParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ShortLinkContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ShortLinkContext $ctx, $op, $args): array
    {
