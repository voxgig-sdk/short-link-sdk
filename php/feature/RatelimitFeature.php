...
// ShortLink SDK ratelimit feature
...
class ShortLinkRatelimitFeature extends ShortLinkBaseFeature
{
    ...
    private function _acquire(ShortLinkContext $ctx): void
    {
    ...
    private function _track(ShortLinkContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
