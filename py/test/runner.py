...
class ShortLinkTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShortLinkTestRunner.getenv("SHORTLINK_TEST_LIVE")
        override = ShortLinkTestRunner.getenv("SHORTLINK_TEST_OVERRIDE")
        ...
        explain = ShortLinkTestRunner.getenv("SHORTLINK_TEST_EXPLAIN")
