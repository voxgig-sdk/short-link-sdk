# ShortLink SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ShortLinkSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ShortLinkSDK(...) and ShortLinkSDK.test(...) become
#      ShortLinkSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "shortlink_sdk"
_SDK_CLASS = "ShortLinkSDK"
