...
from shortlink_sdk.utility.voxgig_struct import voxgig_struct as vs
from shortlink_sdk import ShortLinkSDK
from shortlink_sdk.core.spec import ShortLinkSpec
from shortlink_sdk.core.result import ShortLinkResult
from shortlink_sdk.core.response import ShortLinkResponse
from shortlink_sdk.core.operation import ShortLinkOperation
from shortlink_sdk.core.error import ShortLinkError
from shortlink_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ShortLinkError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ShortLinkSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ShortLinkSDK.test(None, None)
        ...
        class TestInitFeature(ShortLinkBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ShortLinkBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ShortLinkSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ShortLinkSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ShortLinkSDK.test(None, setup_opts)
