# ShortLink Python SDK



The Python SDK for the ShortLink API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.UrlShortening()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/short-link-sdk/releases)) or
...
```
py/
├── shortlink_sdk.py         -- Main SDK module
