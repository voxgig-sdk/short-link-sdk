...
from shortlink_sdk.core.helpers import get_ctx_prop, to_map
...
class ShortLinkContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ShortLinkSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ShortLinkResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ShortLinkResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ShortLinkError(code, msg, self)
