...
from shortlink_sdk.utility import register

# Load features
from shortlink_sdk.feature.base_feature import ShortLinkBaseFeature
from shortlink_sdk.features import _has_feature, _make_feature
...
class ShortLinkSDK:
    ...
    def get_utility(self):
        return ShortLinkUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ShortLinkSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def UrlShortening(self, data=None) -> "UrlShorteningEntity":
        ...
        from shortlink_sdk.entity.url_shortening_entity import UrlShorteningEntity
        return UrlShorteningEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ShortLinkSDK":
        if sdkopts is None:
            sdkopts = {}
