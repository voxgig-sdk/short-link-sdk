...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ShortLinkOmni.make_runner(TEST_JSON_FILE, ShortLinkSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ShortLinkOmni.errify(err)
    end
