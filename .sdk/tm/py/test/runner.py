...
class ShortLinkTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShortLinkTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ShortLinkTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ShortLinkTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
