...
class ShortLinkTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ShortLinkTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ShortLinkTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ShortLinkTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
