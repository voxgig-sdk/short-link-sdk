...
// ShortLink SDK streaming feature
...
class ShortLinkStreamingFeature extends ShortLinkBaseFeature
{
    ...
    private function _iterate(ShortLinkResult $result): \Generator
    {
    ...
    private function _streamable(ShortLinkContext $ctx): bool
    {
