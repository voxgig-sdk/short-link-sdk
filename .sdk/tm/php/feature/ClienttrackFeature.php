...
// ShortLink SDK clienttrack feature
...
class ShortLinkClienttrackFeature extends ShortLinkBaseFeature
{
    ...
    public function PostConstruct(ShortLinkContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ShortLink-SDK';
