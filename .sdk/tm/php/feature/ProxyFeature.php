...
class ShortLinkProxyFeature extends ShortLinkBaseFeature
{
    ...
    public function init(ShortLinkContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ShortLinkContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
