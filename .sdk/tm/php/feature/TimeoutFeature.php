...
class ShortLinkTimeoutFeature extends ShortLinkBaseFeature
{
    ...
    private function _with_timeout(ShortLinkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ShortLinkContext $_ctx, float $ms): void
    {
        $client = $this->client;
