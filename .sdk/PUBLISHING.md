...
|---|---|---|
| `ts/` | @voxgig-sdk/short-link-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/short-link-sdk \
      --repository voxgig-sdk/short-link-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/short-link-sdk` shows it, and
`npm trust revoke @voxgig-sdk/short-link-sdk --id=<id>` removes it.
